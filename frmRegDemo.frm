...
Begin VB.Form frmRegDemo 
   ...
   Caption         =   "Active-X DLL Demonstration Routines"
   ClientHeight    =   7035
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   12585
    ...
    With New clsRegHandler
        Select Case Index
            ...
            Case 2
                ...
                If .Write_Binary(HKEY_CURRENT_USER, "Software\MRU Pro", "testbinary", txtValue(3).Text) Then
            ...
            '//write dword
                ...
                If .Write_Dword(HKEY_CURRENT_USER, "Software\MRU Pro", "testdword", CLng(txtValue(3).Text)) Then
            ...
            Case 6
                ...
                If .Write_StringEX(HKEY_CURRENT_USER, "Software\MRU Pro", "testexpand", txtValue(3).Text) Then
            ...
            Case 8
                ...
                If .Write_LEndian(HKEY_CURRENT_USER, "Software\MRU Pro", "testlittleend", CLng(txtValue(3).Text)) Then
            ...
            Case 10
                ...
                If .Write_BEndian(HKEY_CURRENT_USER, "Software\MRU Pro", "testbigendian", vBEnd) Then
            ...
            Case 12
                ...
                If .Write_String(HKEY_CURRENT_USER, "Software\MRU Pro", "teststring", txtValue(3).Text) Then
            ...
            Case 17
                ...
                Select Case True
                    Case .Search_Value(HKEY_LOCAL_MACHINE, "SOFTWARE\Microsoft\Office\8.0\Word\InstallRoot", "path")
                    ...
                    Case .Search_Value(HKEY_LOCAL_MACHINE, "SOFTWARE\Microsoft\Office\9.0\Word\InstallRoot", "path")
                    ...
                    Case .Search_Value(HKEY_LOCAL_MACHINE, "SOFTWARE\Microsoft\Office\10.0\Word\InstallRoot", "path")
                    ...
                    Case .Search_Value(HKEY_LOCAL_MACHINE, "SOFTWARE\Microsoft\Office\11.0\Word\InstallRoot", "path")
            ...
            '//test write access
            Case 18
                txtValue(3).Text = "Testing write access"
                If .Access_Check(HKEY_CURRENT_USER, "Software\MRU Pro") Then
                    txtResult.Text = "The key can be write accessed"
                Else
                    txtResult.Text = "The key can not be write accessed"
                End If
                
            '//save key
            Case 19
                txtValue(3).Text = "Back up: Software\MRU Pro"
                If .Save_Key(HKEY_CURRENT_USER, "Software\MRU Pro", App.Path & "\regback.kbs") Then
                    txtResult.Text = "The key has been backed up"
                Else
                    txtResult.Text = "The key back up has failed"
                End If
                
            '//restore key
            Case 20
                txtValue(3).Text = "Restore: Software\MRU Pro"
                If .Restore_Key(HKEY_CURRENT_USER, "Software\MRU Pro", App.Path & "\regback.kbs") Then
                    txtResult.Text = "The key has been restored"
                Else
                    txtResult.Text = "The key restore up has failed"
                End If
                
            '//key exists
            Case 21
                txtValue(3).Text = "Key Exists: Software\MRU Pro"
                If .Key_Exists(HKEY_CURRENT_USER, "Software\MRU Pro") Then
            ...
            '//user access rights
            Case 22
                txtValue(3).Text = "Test Privilege: Can user shutdown system?"
                If .Test_Access(eShutdown) Then
                    txtResult.Text = "User has this right"
                Else
                    txtResult.Text = "User does not have this right"
                End If
                
            '//change key permissions
            '//give the standard user account read/write
            '//access to this key, access type allowed,
            '//and apply only to this key
            Case 23
                txtValue(3).Text = "Change Key Permissions: + r, w  for Software\MRU Pro "
                If .Set_Key_Permissions(HKEY_CURRENT_USER, "Software\MRU Pro", "User", _
                Registry_Read_Write, Access_Allowed, Non_Propogate) Then
                    txtResult.Text = "The change was successful"
                Else
                    txtResult.Text = "The change was unsuccessful"
                End If
            ...
            Case 24
                ...
                If .Write_Multi(HKEY_CURRENT_USER, "Software\MRU Pro", "testmulti", sMData) Then
                    txtResult.Text = "Multi value has been added"
                Else
                    txtResult.Text = "Could not write testmulti"
                End If
            ...
            Case 28
                txtValue(3).Text = "00 01 00 01 10 11"
                If .Write_Link(HKEY_CURRENT_USER, "Software\MRU Pro", "testlink", txtValue(3).Text) Then
                    txtResult.Text = "Link Value Written"
                Else
                    txtResult.Text = "Link Value could Not be Written"
                End If
            ...
            Case 30
                txtValue(3).Text = "00 01 00 01 10 11"
                If .Write_ResDesc(HKEY_CURRENT_USER, "Software\MRU Pro", "testresdesc", txtValue(3).Text) Then
                    txtResult.Text = "Resource Description Value Written"
                Else
                    txtResult.Text = "Resource Description could Not be Written"
                End If
                
            '//read hardware resource description
            Case 31
                txtValue(3).Text = "Reading: testresdesc"
                txtResult.Text = .Read_ResDesc(HKEY_CURRENT_USER, "Software\MRU Pro", "testresdesc")
                
            '//write hardware resource list
            '//NOTE* Same warning as above
            Case 32
                txtValue(3).Text = "00 01 00 01 15 11"
                If .Write_ResList(HKEY_CURRENT_USER, "Software\MRU Pro", "testreslist", txtValue(3).Text) Then
                    txtResult.Text = "Resource List Value Written"
                Else
                    txtResult.Text = "Resource List could Not be Written"
                End If
                
            '//read hardware resource list
            Case 33
                txtValue(3).Text = "Reading: testreslist"
                txtResult.Text = .Read_ResDesc(HKEY_CURRENT_USER, "Software\MRU Pro", "testreslist")
                
            '//write hardware resource requirement
            '//NOTE* Same warning as above
            Case 34
                txtValue(3).Text = "00 01 00 01 10 11"
                If .Write_ResRequired(HKEY_CURRENT_USER, "Software\MRU Pro", "testresreq", txtValue(3).Text) Then
                    txtResult.Text = "Resource Requirement Value Written"
                Else
                    txtResult.Text = "Resource Requirement could Not be Written"
                End If
                
            '//read hardware resource requirement
            Case 35
                txtValue(3).Text = "Reading: testresreq"
                txtResult.Text = .Read_ResDesc(HKEY_CURRENT_USER, "Software\MRU Pro", "testresreq")
                
            '//write qword(64bit number)
            Case 36
                Dim cVal As Currency
                cVal = .Convert_Curr("999999999")
                If .Write_Qword(HKEY_CURRENT_USER, "Software\MRU Pro", "testqword", cVal) Then
                    txtResult.Text = "Qword Value Written"
                Else
                    txtResult.Text = "Qword could Not be Written"
                End If
...
On Error GoTo Handler
    ...
    'With New clsRegHandler
    '    .Create_Key HKEY_CURRENT_USER, "Software\MRU Pro"
    'End With
    ...
    sDesc = "** List of exposed functions **" & vbNewLine & vbNewLine & _
            ...
            "Write_String - write a string value" & vbNewLine & "Write_StringEX - write a 64bit dword value" & vbNewLine & _
